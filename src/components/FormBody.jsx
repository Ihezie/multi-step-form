...
const FormBody = () => {
  ...
  return (
    <>
      ...
      >
        <section className="w-[90%] mx-auto bg-white shadow-2xl shadow-light-gray rounded-lg px-6 py-8 relative bottom-20 sm:w-full sm:mx-0 sm:shadow-none sm:static sm:bottom-0 sm:rounded-none sm:bg-transparent sm:mb-16 sm:p-0 lg:mb-20">
      ...
      <div className="bg-white absolute bottom-0 h-20 w-full flex items-center justify-between px-[5%] sm:bg-transparent sm:w-4/5 sm:left-1/2 sm:-translate-x-1/2 sm:px-0 sm:bottom-4 0">
